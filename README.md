...
public class AppylarSample
    : MonoBehaviour,
        AppylarInitializationListener,
        AppylarInterstitialListener,
        AppylarBannerListener
{
    ...
    {
        Appylar.Initialize(
            "<YOUR_APP_KEY>", //APP KEY provided
            new AdType[] { AdType.INTERSTITIAL, AdType.BANNER }, //What type of Ads do you want to integrate
