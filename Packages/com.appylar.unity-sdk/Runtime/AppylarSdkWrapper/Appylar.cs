...
namespace UnityEngine.AppylarSdkWrapper {
  ...
  public static class Appylar {
    ...
    public static void Initialize(string appKey, AdType[] adTypes, bool testMode, AppylarInitializationListener initializationListener) {
    ...
    /// </summary>
    public static void ShowBanner(BannerPosition position, string placementId, AppylarBannerListener bannerListener) {
    ...
    /// </summary>
    public static void ShowInterstitial(string placementId, AppylarInterstitialListener interstitialListener) {
